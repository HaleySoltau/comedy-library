# Specials needing manual verification

Working notes for the YouTube-link backfill project. Links here were added to
`data/specials.json` but flagged by research as **uncertain** — plausible, but
not confirmed to be the exact right video. Spot-check each one; if it's wrong,
either fix the link or blank it back out.

This file isn't read by the site — it's just a running checklist for us.

## Batch 1 (SpecialIDs 1–22)

- [ ] **Back to Back: The Crowd Work Special** (Akaash Singh) — SpecialID 5 — https://www.youtube.com/watch?v=ePpIH_u6bHE
  Found on his own channel as "Entire Comedy Show of ONLY Crowd Work" — title doesn't match exactly, may be a different/retitled special.
- [ ] **Big Ol' Sweet Iced Tea** (Anita Renfroe) — SpecialID 19 — https://www.youtube.com/watch?v=ZHp6C0MapYw
  Appears to be on her own channel, but not labeled "full special" like her other uploads — may be a clip rather than the complete special.

## Batch 2 (SpecialIDs 23–45)

- [ ] **The Homecoming Show** (Anjelah Johnson-Reyes) — SpecialID 23 — https://www.youtube.com/watch?v=DBKcgpgJOAo
  Posted by a third-party channel ("Punchline"), not her own channel or a confirmed licensed distributor.
- [ ] **Mahalo & Goodnight** (Anjelah Johnson-Reyes) — SpecialID 25 — https://www.youtube.com/watch?v=t2UzxfXf8P8
  Same "Punchline" channel situation as above — unverified licensing status.

## Batch 3 (SpecialIDs 46–73)

- [ ] **Conservative Unleashed** (Brad Stine) — SpecialID 50 — https://www.youtube.com/watch?v=B1ufSDjjKY8
  ⚠️ Possible unauthorized reupload — posted by an unrelated third-party channel ("Christian Movies"), not Stine's own channel or a known distributor.
- [ ] **Wussification** (Brad Stine) — SpecialID 52 — https://www.youtube.com/watch?v=9h153xq20yM
  ⚠️ Possible unauthorized reupload — same "Christian Movies" channel as above.

## Batch 4 (SpecialIDs 74–101)

- [ ] **Stand Up for Families** (Chonda Pierce) — SpecialID 82 — currently links to only Part 1 of 3
  This is actually a 3-episode series on the official "Free Movies By Cineverse" channel, not a single video. Our schema only holds one link, so it's set to Part 1 ("Home Is Where the Heart Is"). Parts 2 and 3 aren't linked anywhere:
  - Part 2, "Food, Faith & Family": https://www.youtube.com/watch?v=-UQdBiFCQ_g
  - Part 3, "Family Is Forever and Ever, Amen": https://www.youtube.com/watch?v=zXqWMZQcah8

## Batch 7 (SpecialIDs 150–176)

- [ ] **Happy Wife, Happy Life** (Jeff Allen) — SpecialID 150 — https://www.youtube.com/watch?v=satLUmt0lrM
  ⚠️ Year discrepancy — our record says 1998, but the YouTube video itself is labeled 2002. Same official channel he distributes all his specials through, so likely the right special, just double-check the year (or it could be a re-recording/re-release).

## Batch 9 (SpecialIDs 204–231)

- [ ] **7 More Days in the Tank** (Josh Blue) — SpecialID 213 — https://www.youtube.com/watch?v=YtqQPUqIoXk
  Uploaded by "MyComedyStore," a real digital comedy distributor, but not one of the pre-verified authorized channels — plausible but not confirmed.
- [ ] **Comedy Central Presents: Kathleen Madigan** (Kathleen Madigan) — SpecialID 229 — https://www.youtube.com/watch?v=Ri-hEUZe2I4
  ⚠️ Title mismatch — the video (on the official Comedy Central Stand-Up channel) is titled "It's a Sign of the End of the World," not "Comedy Central Presents: Kathleen Madigan." Likely the same special under a different title, but worth confirming.

## Batch 11 (SpecialIDs 262–281)

- [ ] **Comedy: The Road Less Traveled** (Michael Jr) — SpecialID 267 — https://www.youtube.com/watch?v=1f8Ts5UxebI
  Uploaded on CBN's official "The 700 Club" channel (a legitimate broadcaster), but not one of the pre-verified authorized distributors — plausible but not confirmed.

## Batch 12 (SpecialIDs 284–303)
